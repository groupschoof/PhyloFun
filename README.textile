...
* @-e@ provide comma separated list of GO evidence codes you want to be accepted as "trusted", e.g. @-e ISO,RCA@ or provide @-e ALL@ if any evidence code is good for you
...
* @-m true@ to print out statistics of each generated Multiple Sequnce Alignment (MSA) - result_file @msa_stats.txt@
...
The only thing you have to do, is to run _either_ BLAST or _PHMMER_ for your query proteins against the provided database of UniprotKB proteins with trusted Gene Ontology term annotations (*trusted-UniKB*).
