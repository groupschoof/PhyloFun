...
bc. Rscript <path_to_your_PhyloFun_installation>/exec/runPhyloFun.R -q <path_to_your_PhyloFun_installation>/inst/protein_1.fasta -b <path_to_your_PhyloFun_installation>/protein_1_blastout.tbl -f FastTree -h true -r true -m true
